...
import com.example.pemesanantiket.viewmodel.InputDataViewModel
import kotlinx.android.synthetic.main.activity_input_data.*
import java.text.SimpleDateFormat
import java.util.*

class DataKapalActivity : AppCompatActivity() {
    val strAsal = arrayOf("Jakarta", "Semarang", "Surabaya", "Bali") // String asal kita berangkat
    val strTujuan = arrayOf("Jakarta", "Semarang", "Surabaya", "Bali") // String tujuan kita kemana
    val strKelas = arrayOf("Eksekutif", "Bisnis", "Ekonomi") // String untuk tipe/kelas
    ...
    private fun setViewModel() { // Untuk menampilkan view model
    ...
    private fun setToolbar() { // Untuk menampilkan toolbar
    ...
    private fun setInitView() { // Untuk inputan tanggal atau kalender
    ...
    private fun setSpinnerAdapter() { // Untuk menampilkan spinner kota
        val adapterAsal =
    ...
    private fun setJmlPenumpang() { // Untuk set jumlah penumpang
        //add anak
    ...
    private fun setInputData() { // Untuk set data penumpang
    ...
    private fun setPerhitunganHargaTiket() {
        //set Asal & Tujuan setiap activity Kapal, Kereta, Pesawat harganya berbeda
